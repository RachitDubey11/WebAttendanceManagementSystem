...
<div class="container">
  ...
  <ul class="breadcrumb">
   ...
   <spring:url value="/admin" var="admin"/>
    ...
    <li class=active>
    <a href="<c:url value='/teachers/edit/${teacher.idTeacher}'/>">Edit Teacher Detail</a>
    </li>    
  </ul>
</div>
...
<c:url var="action" value="/teachers/update"></c:url>
<c:url var="action" value="/teachers/update"></c:url>
<form:form action="${action}" method="POST" modelAttribute="teacher">
	<div class="xyz" >	
		<form:hidden path="idTeacher" />
	 	<form:errors path="idTeacher" cssClass="error"/>
	</div>
	<div class="xyz" >	
		<Label>Teacher's Name:</Label>
		<form:input path="teacherName" required="true" />
	...
	<div class="text-center"><input type="submit" value="Update User" class="btn" style="width:180px;height:50px;border:0;" />
	</div>
