...
<title>Select Sem Dept View Attendance</title>
<style>
.bb{
margin-top: 90%;
margin-left: 5%;
...
<div class="container">
  ...
  <spring:url value="/admin" var="admin"/>
    ...
    <spring:url value="/attendance/yearSearch" var="attendance"/>
     ...
     <li class="active">  
      <spring:url value="/attendance/semdeptSearch" var="attendance"/>
        <a href="#">Select Sem. & Dept.</a>
        </li>
        </ul>
      </div>
...
<div class="well" style="border-width:0px;margin-left: 280px; background-color:azure; border-style:ridge; width:55%; border-radius: 15px;  padding: 27px;">	
<c:url var="action" value="/attendance/subjectSearch/${idYear}"></c:url>
