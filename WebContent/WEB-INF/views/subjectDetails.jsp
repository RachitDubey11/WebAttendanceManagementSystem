...
<div class="container-fluid text-center">    
  ...
  <a href="<c:url value='/subject/register/${idSem}'/>">
  <img src="<c:url value="/resource/images/ads.png"/>" class="img-thumbnail" style="width:42px;height:42px;border:0;"><b>Add Subjects</b></a>
 <br>
    </div>
...
<th>Delete</th>
	...
	<c:forEach items="${subjectValue}" var="subject">
	<tr>
	<td></td>
	 <td><c:out value="${subject.subjectName}"/></td>
	<td><c:out value="${subject.dept }"/></td>
	<td><c:out value="${subject.semName}"/></td> 
	<td><a class="btt" href="<c:url value='/subject/edit/${subject.code}/${idSem}'/>">Edit</a></td>
	<td><a class="btt" href="<c:url value='/subject/delete/${subject.code}/${idSem}'/>">Delete</a>
	</td>
	</tr>
	</c:forEach>
	</table>
