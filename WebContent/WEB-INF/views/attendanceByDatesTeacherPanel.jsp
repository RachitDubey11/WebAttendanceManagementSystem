...
<title>View Attendance By Date-Teacher Panel</title>
...
<li class="active">  
 ...
 <li><spring:url value="/attendance/viewMonthlyTeacherPanel/${idSem}/${code}" var="attendance"/>
       <a href="${attendance}">Select Month</a></li>  
    <li class="active">
     <spring:url value="/teacher" var="teacher"/>
...
<tr>
<td></td>
		 <td><c:out value="${attendance.studentName}"/></td>
		 <td><c:out value="${attendance.password}"/></td>
