...
<title>View Older Attendance</title>
  ...
  <ul class="nav nav-pills">
    ...
    <spring:url value="/teacher" var="teacher"/>
     ...
     <li><a></a></li><li><a></a></li><li><a></a></li><li><a></a></li><li><a></a></li><li><a></a></li><li><a></a></li>
        ...
        <li> <a class="btn" href="<c:url value="/logout" />"><span class="glyphicon glyphicon-log-out"></span> Logout</a>
 </li>
  </ul>
</div>
</div>
...
<div class="container">            
  <ul class="breadcrumb">
    ...
    <li><spring:url value="/attendance/takeOlderAttendance/${idSem}/${code}" var="attendance"/>
       <a href="${attendance}">Select Month</a>
       </li>
    <li>
     <spring:url value="/teacher" var="teacher"/>
       <a href="#">Older Attendance</a>   
    </li> 
 </ul>
</div>
...
<div class="container-fluid text-center">    
  ...
  <div class="col-sm-1 sidenav">
     ...
     <div class="col-sm-8 text-left"> 
      <h2>Date List</h2>
<table class="table table-striped"  cellspacing="0" width="80%" border="0">
<tr>
<th>SrNo.</th>
<th>Date</th>
<th>Edit</th>
...
<c:forEach items="${dates}" var="attendance">
    ...
    <td><a class="btt" href="<c:url value='/attendance/takeNewOlderAttendance/${idSem}/${code}/${attendance}/${idMonth}'/>">Edit</a></td>
	<td><a class="btt" href="<c:url value='/attendance/delete/${idSem}/${code}/${attendance}'/>">Delete</a></td>
	</tr>	
	</c:forEach>	
</table>
</div>
