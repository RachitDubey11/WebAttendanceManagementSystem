...
<title>Older Attendance teacherpanel</title>
...
<c:url var="action" value="/attendance/viewMonthlyTeacherPanel/${idSem}/${code}/${idYear}"></c:url>
<form:form action="${action}" method="POST" modelAttribute="month">
<tr>
				<td>Month:</td>
				<td><form:select path="monthName">
						<form:options items="${viewMonthList}" />
