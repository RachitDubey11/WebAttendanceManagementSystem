...
<br>
<div class="well" style="border-width:0px;margin-left: 250px; background-color:azure; border-style:ridge; width:58%; border-radius: 15px;  padding: 25px;">

<c:url var="action" value="/subject/update/${idSem}"></c:url>
<form:form action="${action}" method="POST" modelAttribute="subject">
	            <tr>
		        <td>Subject's Name:</td>
				<td><form:input path="subjectName" required="true"/></td>
				<td><form:errors path="subjectName" cssClass="error"/></td>
		        </tr>
		       	
		       	<tr>  
		       	<td><form:input type="hidden" path="code" /></td> 
		       	</tr>
		
		<tr>
		<td colspan="2"><input type="submit" value="Update Subject" class="btn" style="width:150px;height:50px;border:0;"/></td>
		</tr>
</form:form>
 </div>
 </div>
