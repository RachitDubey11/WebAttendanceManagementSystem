...
<title>Admin select year for Attendance</title>
<style>
.bb{
margin-top: 90%;
margin-left: 5%;
...
<div class="container-fluid text-center">    
  ...
  <div class="well" style="border-width:0px;margin-left: 350px; background-color:azure; border-style:ridge; width:37%; border-radius: 15px;  padding: 25px;">	
   
<c:url var="action" value="/attendance/semdeptSearch"></c:url>
<form:form action="${action}" method="POST" modelAttribute="year">
		<tr> 
				<td>Year:</td>
				<td><form:select name="yearName" path="yearName">
