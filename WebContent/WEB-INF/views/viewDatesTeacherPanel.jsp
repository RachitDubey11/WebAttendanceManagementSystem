...
<title>View Old Attendance teacher</title>
  ...
  <ul class="breadcrumb">
    <li>
     <spring:url value="/teacher" var="teacher"/>
      ...
      <li>  
      <spring:url value="/attendance/viewAttendance/${idSem}/${code}" var="a"/>
       <a href="${a}">View Attendance</a>
        </li>
    <li><spring:url value="/attendance/viewMonthlyTeacherPanel/${idSem}/${code}" var="attendance"/>
...
<c:forEach items="${dates}" var="attendance">
    ...
    <td><a class="btt" href="<c:url value='/attendance/attendanceByDatesTeacherPanel/${idSem}/${code}/${attendance}/${idMonth}'/>">View</a></td>
	</tr>	
	</c:forEach>
</table>
</div>
